...
This file is the quick-reference operating contract for aws-credential-types-kotlin. The longer
...
aws-credential-types-kotlin is a Kotlin Multiplatform port of the upstream Rust crate or module
[`aws-credential-types`](https://crates.io/crates/aws-credential-types). Upstream Rust is the behavioral oracle while the
