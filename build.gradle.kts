...
kotlin {
    ...
    val xcf = XCFramework("AwsCredentialTypes")

    macosArm64 {
        binaries.framework { baseName = "AwsCredentialTypes"; xcf.add(this) }
    }
    iosArm64 {
        binaries.framework { baseName = "AwsCredentialTypes"; xcf.add(this) }
    }
    ...
    swiftExport {
        moduleName = "AwsCredentialTypes"
        flattenPackage = "io.github.kotlinmania.awscredentialtypes"
    }

    android {
        namespace = "io.github.kotlinmania.awscredentialtypes"
        compileSdk = 34
        minSdk = 24
...
mavenPublishing {
    ...
    coordinates(group.toString(), "aws-credential-types-kotlin", version.toString())

    pom {
        name.set("aws-credential-types-kotlin")
        description.set("Kotlin Multiplatform port of smithy-lang/smithy-rs - Types for AWS SDK credentials")
        inceptionYear.set("2026")
        url.set("https://github.com/KotlinMania/aws-credential-types-kotlin")
        ...
        scm {
            url.set("https://github.com/KotlinMania/aws-credential-types-kotlin")
            connection.set("scm:git:git://github.com/KotlinMania/aws-credential-types-kotlin.git")
            developerConnection.set("scm:git:ssh://github.com/KotlinMania/aws-credential-types-kotlin.git")
        }
    }
}
...
val fullTargetBuildTasks = listOf(
    ...
    "assembleAwsCredentialTypesXCFramework",
)
...
val fullTargetBuildTasks = listOf(
    ...
    "assembleAwsCredentialTypesXCFramework",
    "assembleAwsCredentialTypesDebugXCFramework",
    "assembleAwsCredentialTypesReleaseXCFramework",
    "assembleDebugIosFatFrameworkForAwsCredentialTypesXCFramework",
    "assembleReleaseIosFatFrameworkForAwsCredentialTypesXCFramework",
    "assembleDebugIosSimulatorFatFrameworkForAwsCredentialTypesXCFramework",
    "assembleReleaseIosSimulatorFatFrameworkForAwsCredentialTypesXCFramework",
    "assembleDebugMacosFatFrameworkForAwsCredentialTypesXCFramework",
    "assembleReleaseMacosFatFrameworkForAwsCredentialTypesXCFramework",
    "assembleDebugTvosFatFrameworkForAwsCredentialTypesXCFramework",
    "assembleReleaseTvosFatFrameworkForAwsCredentialTypesXCFramework",
    "assembleDebugTvosSimulatorFatFrameworkForAwsCredentialTypesXCFramework",
    "assembleReleaseTvosSimulatorFatFrameworkForAwsCredentialTypesXCFramework",
    "assembleDebugWatchosFatFrameworkForAwsCredentialTypesXCFramework",
    "assembleReleaseWatchosFatFrameworkForAwsCredentialTypesXCFramework",
    "assembleDebugWatchosSimulatorFatFrameworkForAwsCredentialTypesXCFramework",
    "assembleReleaseWatchosSimulatorFatFrameworkForAwsCredentialTypesXCFramework",
